...
# train_texts = traduire(train_texts)
train_texts = [traduire(text) for text in train_texts]
# val_texts = traduire(val_texts)
val_texts = [traduire(text) for text in val_texts]
...
output_model_dir = "C:\\Users\\USER\\Desktop\\IDS4\\SEMESTRE 2\\NLP\\projet\\modele_classification2"
